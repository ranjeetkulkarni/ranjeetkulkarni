...
#### *1. Cibo-Genie: Food Health Chatbot*  
*Tech*: Python, Flask, OpenAI API, Google Maps API, JavaScript  
- Analyzes food items to provide *nutritional insights, **consumption guidelines, and **nearest store locator* via integrated APIs.  

#### *2. SketchColorizer: Real-Time GAN Image Generator*  
*Tech*: Python, TensorFlow, GANs, OpenCV  
- Converts sketches to colored images in real time with *sub-100ms latency* using generative adversarial networks.  

#### *3. HR Attrition Predictor*  
*Tech*: Python, Scikit-learn, Pandas, Streamlit  
- Predicts employee attrition risk using *32+ features* (experience, income, commute, etc.) with *97% accuracy*.
